...
function move() {
    ...
    if (isSnakeUnit(new_unit) || new_unit.getAttribute('class').includes('wall-unit')) {
        finishTheGame();
    }
    else {
...
function haveFood(unit) {
    ...
    if (unit_classes.includes('food-unit')) {
        ...
        createFood();
        score++;
        document.querySelector(".scoreOnline").innerText = "Ваш результат: " + score
    }
    return check;
}
/**
